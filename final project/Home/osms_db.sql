...
(1, 'Anusha', 'admin@gmail.com', '12345');
...
CREATE TABLE `technician_tb` (
  ...
  `empEmail` varchar(60) COLLATE utf8_bin NOT NULL
   `tech_img` varchar(20) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `technician_tb` (`empid`, `empName`, `empCity`, `empMobile`, `empEmail`,'tech_img') VALUES
(12, 'Tech1', 'Delhi 4', 1234, 'tech@gmail.com','7899-7865-6605');
