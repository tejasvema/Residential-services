...
<div class="col-sm-6 mt-5  mx-3">
  ...
  if(isset($_REQUEST['checkid'])){
    ...
    $sql = "SELECT tech_img FROM technician_tb ";
  ...
  <table class="table table-bordered">
    <tbody>
      ...
      <tr>
        ...
        <td> <?php if(isset($row['assign_tech'])) {echo $row['assign_tech']; } ?><br>vaccinated <span style="font-family: Arial Unicode MS, Lucida Grande">
        &#x2705; &#9989;
</span></td>
      </tr>
      <tr>
      <tr>
        ...
        <td>  <?php if(isset($row1['tech_img'])) {echo $row1['tech_img']; } ?></td>
      </tr>
      <tr>
        <td>Customer Sign</td>
        <td></td>
  ...
  <div class="text-center">
    ...
    <form class="d-print-none d-inline" action="requesterLogin.php"><input class="btn btn-secondary" type="submit" value="Close"></form>
  </div>
  <?php } 
  else {
