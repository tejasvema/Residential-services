...
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    <div class="form-group">
      <label for="inputRequestInfo">Kind of Service</label>
      <input type="text" class="form-control" id="inputRequestInfo" placeholder="Kind of Service" name="requestinfo">
    </div>
    <div class="form-group">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputZip" name="requesterzip" maxlength="6" onkeypress="isInputNumber(event)">
      </div>
    </div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputMobile" name="requestermobile"  pattern="[7-9]{1}[0-9]{9}" maxlength="10" onkeypress="isInputNumber(event)">
        
      </div>
      <div class="form-group col-md-2">
        <label for="inputDate">Date</label>
        <input type="date" class="form-control" id="inputDate" name="requestdate" min="2023-07-13" onkeypress="date(event)" >
      </div>
    </div>
